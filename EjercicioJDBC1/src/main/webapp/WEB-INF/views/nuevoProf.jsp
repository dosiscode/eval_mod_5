...
<html lang="es">
  <head>
    <title>ADMINISTRADOR || Nuevo Profesional</title>
    <!-- Required meta tags -->
    <meta charset="utf-8" />
    <meta
      name="viewport"
    ...
    <div class="container mt-5">
    	<div class="row d-flex justify-content-center">
    		<div class="col-12 col-lg-6 col-md-6 border shadow p-4">
    			<form action="${pageContext.request.contextPath}/agregarProfesional" method="POST">
                	...
                	<div class="form-group">
                    	 ...
                    	 id="apellido"
                    	 class="form-control"
                    	 placeholder="Ingresa el apellido del profesional"
                  	 	/>
                	</div>
                	<div class="form-group d-flex justify-content-end">
                		<a href="${pageContext.request.contextPath}/mantenedor/profesional"><input type="button" class="btn btn-sm btn-danger" value="Cancelar"/></a>
