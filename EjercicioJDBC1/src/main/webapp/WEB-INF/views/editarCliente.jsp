...
<html lang="es">
  <head>
    <title>ADMINISTRADOR || Editar Cliente</title>
    <!-- Required meta tags -->
    <meta charset="utf-8" />
    <meta
      name="viewport"
    ...
    <div class="container mt-5">
    	<div class="row d-flex justify-content-center">
    		<div class="col-12 col-lg-6 col-md-6 border shadow p-4">
    			<form action="${pageContext.request.contextPath}/editarCli" method="POST">
    				<h1>Editar Cliente</h1>
    				<hr>
    				<input type="text" hidden="false" name="id_cliente" id="id_cliente" value="${cEdit.getId_cliente()}" readonly />
					...
					<select name="comuna" required="required">
						<c:forEach var="comuna" items="${comunas}">
							<c:choose>
								<c:when test="${comuna.getId_comuna() eq cEdit.getComuna_id_comuna()}">
									<option selected="selected" value="${comuna.getId_comuna()}">${comuna.getComuna()}</option>
								</c:when>
								<c:otherwise>
                	...
                	<div class="form-group d-flex justify-content-end">
                		<a href="${pageContext.request.contextPath}/mantenedor/cliente"><input type="button" class="btn btn-sm btn-warning" value="Volver"/></a>
